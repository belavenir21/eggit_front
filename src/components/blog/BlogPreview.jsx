    ...
    return (
        <div className="flex-1 p-8 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="w-full max-w-5xl h-[85vh] bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200 flex flex-col z-10 transition-all duration-500 ease-in-out blog-preview">
                ...
                {/* [Modified] Windows Style Browser Header */}
                <div className="bg-[#f3f3f3] h-10 flex items-center justify-between px-4 border-b border-gray-300 select-none">
                    {/* Left: Title / URL Bar */}
                    <div className="flex items-center gap-3 flex-1">
                        <div className="bg-white border border-gray-300 rounded px-3 py-1 text-xs text-gray-500 w-2/3 max-w-[400px] flex items-center gap-2">
                            <span className="text-gray-400">🔒</span>
                            https://{nickname || 'user'}.github.io
                        </div>
                    </div>

                    {/* Right: Windows Controls (Minimize, Maximize, Close) */}
                    <div className="flex items-center gap-4 text-gray-500">
                        <button className="hover:bg-gray-200 p-1 rounded"><Minus size={16} strokeWidth={1.5} /></button>
                        <button className="hover:bg-gray-200 p-1 rounded"><Square size={14} strokeWidth={1.5} /></button>
                        <button className="hover:bg-red-500 hover:text-white p-1 rounded transition-colors"><X size={18} strokeWidth={1.5} /></button>
                    </div>
                </div>
                            ...
                            <div className="w-64 flex flex-col p-6 shrink-0 transition-colors duration-300" style={sidebarStyle}>
                                <div className="mb-8">
                                    <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden border-4 border-white/10 shadow-sm mx-auto">
                                        {/* Avatar Preview */}
                                        <img
                                            src={avatarUrl || `https://github.com/${nickname}.png`}
                                            alt="Profile"
                            ...
                            <div className="flex-1 p-10 overflow-y-auto" style={bgStyle}>
                                <div className="max-w-3xl mx-auto">
                                    <div className="mb-12 text-center">
                                        ...
                                        <p className="text-gray-500 text-lg">{blogDescription}</p>
                                    </div>
